...
def test_valid_deserialise(
    price_component: PythPriceComponent, price_component_bytes: bytes
):
    actual = PythPriceComponent.deserialise(
        price_component_bytes, exponent=price_component.exponent
    )
...
def test_deserialise_null_publisher_key(
    price_component: PythPriceComponent, price_component_bytes: bytes
):
    ...
    actual = PythPriceComponent.deserialise(
        bad_bytes, exponent=price_component.exponent
    )
